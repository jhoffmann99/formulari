...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  protected boolean shouldNotFilter(HttpServletRequest request)
    ...
    return "/api/auth/signin".equals(path) || "/api/auth/signup".equals(path) || path.startsWith("/api/check/reply")
        || path.startsWith("/api/check/details/") || path.startsWith("/api/check/template/");
  }
